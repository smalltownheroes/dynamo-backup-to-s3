...
DynamoBackup.prototype.backupTable = function (tableName, backupPath, callback) {
    ...
    console.log('awsAccessKey: ' + self.awsAccessKey);
    console.log('awsSecretKey: ' + self.awsSecretKey);
    console.log('awsRegion: ' + self.awsRegion);
    console.log('bucket: ' + self.bucket);
    console.log('path: ' + path.join(backupPath, tableName + '.json');
...
DynamoBackup.prototype.backupTables = function (tables, callback) {
    var self = this;
